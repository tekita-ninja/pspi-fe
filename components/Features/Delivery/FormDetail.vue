  ...
  <div>
    ...
    <div class="p-3 border rounded-lg">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div v-for="item in controller.detail.bukti_pengiriman" class="border p-2 aspect-video w-full">
          <img class="w-full h-full object-contain" :src="toAssetLink(item.image)" alt="image">
        </div>
      </div>
    </div>
    <div class="space-y-3">
      <div class="grid md:grid-cols-3 gap-3">
        ...
        <div>
          <div v-if="driverSelected" class=" my-3 border rounded-md p-3">
            <div class="text-sm uppercase font-bold mb-2">Info Driver</div>
