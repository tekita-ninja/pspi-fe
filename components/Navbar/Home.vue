...
<template>
  <nav class="sticky top-0 z-50 px-5 md:px-20 bg-orange-primary">
    ...
    <div
      ...
      <div class="px-5 md:px-10">
        ...
        <div class="flex flex-col">
            <div v-for="item in links" :key="item" class="flex justify-center py-3 border-b-[1px] border-b-white ">
